...
namespace Interactive360
{
    ...
    public class RaycastInput : MonoBehaviour
    {
        ...
        [SerializeField] float rayDistance = 500f;           //The distance that the input ray should be cast use to be 20f
        ...
        [SerializeField] float defaultLineDistance = 50000f;   //The distance in front of the player that the line ends if nothing is highlighted 10
